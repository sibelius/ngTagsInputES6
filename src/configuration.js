...
class TagsInputConfig {
  ...
  setDefaults = (directive, defaults) => {
    this.globalDefaults[directive] = defaults;
    return this;
  };
  ...
  setActiveInterpolation = (directive, options) => {
    this.interpolationStatus[directive] = options;
    return this;
  };
  ...
  setTextAutosizeThreshold = (threshold) => {
    this.autosizeThreshold = threshold;
    return this;
  };
  ...
  $get = ($interpolate) => {
    ...
    var converters = {};
    converters[String] = (value) => value;
    converters[Number] = (value) => parseInt(value, 10);
    converters[Boolean] = (value) => value.toLowerCase() === 'true';
    converters[RegExp] = (value) => new RegExp(value);

    return {
      load: (directive, scope, attrs, options) => {
